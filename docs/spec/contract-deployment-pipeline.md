...
ignored_settings:
  - settings.values.demi_root@handle_settings.mpt_root_hash
settings:
...
- ignore configured paths such as `demi_root@handle_settings.mpt_root_hash`,
...
- `demi_root@handle_settings`: minting-data datum
