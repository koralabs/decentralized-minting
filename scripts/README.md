...
2. Spend `demi_root@handle_settings` from old `minting_data` script and send that to new `minting_data` script

- Must attach correct MPT root hash to `demi_root@handle_settings`
