...
- next_task_id: `none` (every remaining task is blocked — DSH-501 on user dev-approach/package-publish decision; pz chain DSH-300→301→302→303 + DSH-404/405/502/503/601/602/603 transitively on DSH-300 user action)
- total_tasks: `26`
- completed_tasks: `14`
- blocked_tasks: `2`
- overall_status: `blocked_on_user`
- last_updated_utc: `2026-06-06T02:45:00Z`
