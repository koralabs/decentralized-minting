...
- current_task_id: `DSH-303`
- next_task_id: `DSH-404` (pkg burn build; deps DSH-401+402+301 — all done after DSH-303) / `DSH-501` (engine mint) — both ready
- total_tasks: `26`
- completed_tasks: `17`
- blocked_tasks: `0`
- overall_status: `ready`
- last_updated_utc: `2026-06-06T03:30:00Z`
...
| DSH-303 | in_progress | DSH-301 | handles-personalization | 2026-06-06T03:30:00Z | — | — | make pz personalize/migrate/revoke/ownership $handle_policies-aware (reuse DSH-301 reader; replace hardcoded f0ff48bb on USER-handle policy checks only — NOT the legacy settings/registry handle reads). Branch parity/demi-pz-policy-burn |
